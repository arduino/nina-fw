...
1. Clone **v3.3** of the IDF: `git clone --branch release/v3.3 --recursive https://github.com/espressif/esp-idf.git`
1. Set the `IDF_PATH` environment variable: `export IDF_PATH=<path/to/idf>`
1. Run `make menuconfig` then press save and then exit
